                    ...
                    switch (response[2])
                    {
                        case "success":
                            ...
                            else
                            {
                                ...
                                {
                                    MessageBox.Show("New Update Found, Get new update from ZeusAIO Discord Server!", Name, MessageBoxButton.OK, MessageBoxImage.Error);
                                    Process.GetCurrentProcess().Kill();
                                }
                ...
                try
                {
                    ...
                    switch (response[2])
                    {
                        ...
                        case "invalid_details":
                            ...
                            Console.WriteLine();
                            Console.WriteLine("Email or Password Invalid", Color.DarkRed);
                            Thread.Sleep(2000);
                            Environment.Exit(0);
                            Security.End();
                        ...
                        case "hwid_updated":
                            ...
                            Console.WriteLine();
                            Console.WriteLine("Your HWID has Been Resetted ; Please Reopen", Color.Green);
                            Thread.Sleep(2000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                        case "invalid_hwid":
                            Console.ForegroundColor = ConsoleColor.DarkRed;
                            Console.WriteLine();
                            Console.WriteLine("Hwid Error", Color.Green);
                            Thread.Sleep(2000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
                ...
                try
                {
                    ...
                    switch (response[2])
                    {
                        ...
                        case "invalid_license":
                            Console.ForegroundColor = ConsoleColor.DarkRed;
                            Console.WriteLine("License Does Not Exist!!!", Color.Green);
                            Thread.Sleep(3000);
                            Security.End();
                            Process.GetCurrentProcess().Kill();
                            return false;
